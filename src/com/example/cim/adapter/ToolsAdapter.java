...
public class ToolsAdapter extends BaseAdapter {
	...
	protected static final String TAG = "ToolsAdapter";
	private Context mContext;
	private List<ToolEntity> lists;
	private CustomListView mCustomListView;
	
	public ToolsAdapter(Context context, List<ToolEntity> lists,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		Holder holder;
		ToolEntity te = lists.get(position);
		if (convertView == null) {
...
//		loadBitmaps(holder.iv, path);
		holder.iv.setImageResource(R.drawable.tool);
		holder.tv_name.setText(te.getToolName());
		holder.tv_feel.setText(te.getDescription());
		if(te.getPlateform().equals("0")){
			holder.tv_time.setText("PC");
		}else if(te.getPlateform().equals("1")){
			holder.tv_time.setText("终端");
		}else{
			holder.tv_time.setText("移动");
		}
		return convertView;
	}
