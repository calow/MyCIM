...
public class TitleBarView extends RelativeLayout {
	...
	private void initView(){
		...
		btn_titleLeft = (Button) findViewById(R.id.contact_group);
	...
	public void setCommonTitle(int LeftVisibility,int centerTextViewVisibility,int centerButtonVisibilter,int rightVisibility){
		...
		common_constact.setVisibility(centerButtonVisibilter);
	}
