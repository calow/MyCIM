...
import com.example.cim.adapter.CIMconstactAdapter;
...
public class CIMconstactFragment extends Fragment {
	...
	private CIMconstactAdapter mAdapter;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mBaseView = inflater.inflate(R.layout.fragment_cim_constact, null);
		findView();
		init();
		return mBaseView;
	}
	...
	private void init() {
		mAdapter = new CIMconstactAdapter(mContext, users, mCustomListView);
		...
		mPhone.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				FragmentTransaction ft = getFragmentManager()
						.beginTransaction();
				PhoneConstactFragment fragment = new PhoneConstactFragment();
				ft.replace(R.id.rl_constact, fragment);
